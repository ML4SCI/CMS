"""Standard pre-LN feed-forward network shared by the variant blocks.

Lifted from the project's earlier hybrid-transformer tree (standard pre-LN
FFN); retained so variant blocks are self-contained.
"""
