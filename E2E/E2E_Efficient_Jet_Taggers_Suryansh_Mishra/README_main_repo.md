...
- [Setup](#setup) · [Dataset](#dataset) · [Usage](#usage)
...
Source: [ml4sci_cms_e2e26](https://github.com/omasho-codes/ml4sci_cms_e2e26) (`nohup/lgatr_bench.out`, `parT_bench.out`, `lgatr_train_e2e.out`, `hybrid_train_e2e.out`).
...
└── requirements.txt
logs/
├── RESULTS.md           compact claim and provenance ledger
└── results_tables.md    frozen tables; this README quotes from it
```

`ml4sci_26/README.md` documents the data contract; `ml4sci_26/ablation/README.md` documents
the trainer and every config field.
...
```bash
git clone https://github.com/omasho-codes/gsoc_26.git && cd gsoc_26
python -m venv .venv && source .venv/bin/activate
pip install -r ml4sci_26/requirements.txt
...
export PYTHONPATH=$PWD/ml4sci_26
```
...
```bash
python ml4sci_26/dataloader/ragged_loader.py      # loader self-check on synthetic shards
python -c "
